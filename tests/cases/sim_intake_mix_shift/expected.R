...
expected_cox_stratified_period <- list(
  ...
  # same truth checked twice, now under a free per-size baseline. The tie
  # rule this variant fits under is pinned in massive_daily_ties, where the
  # two rules stand a third of a hazard ratio apart instead of 0.04.
  HR_periodPeriod_2 = c(1.5, 0.38),
  HR_periodPeriod_3 = c(1.5, 0.38)
)
