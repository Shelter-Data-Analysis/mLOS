...
- **Animals still in the shelter have not finished their stay yet.** If you exclude them, you bias your numbers downward: the animals with the longest stays are exactly the ones most likely to still be there. mLOS treats them correctly as "still counting" (statisticians call this right-censoring).
