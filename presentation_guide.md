...
presentation guide, version 20260911_001. Read it in any markdown reader,
...
page size, 13.333 by 7.5 inches, and a template that is not is refused with
what to change. Type stays Calibri, which is what the column widths and the
page breaks are measured in; a wider face wraps a table header mid-word.
